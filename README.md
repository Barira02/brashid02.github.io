...
**Live site:** https://barira02.github.io
...
| Add an award | `honors:` |
| Add a story map, podcast, essay, dataset, report, talk | `scicomm:` → copy a block, set `type:` and `links:` |
| Fix my ORCID / Scholar link | `profile.links` |
| Change my tagline or bio | `profile.thesis` / `about.paragraphs` |
| Add a qualification / move a map pin | `qualifications:` (drives **both** the map pins and the timeline) |
| Add a workplace to the map | `affiliations:` |
| Rename the two map layers | `mapLabels:` |
| Change the headline | `profile.thesis` (alternatives listed in the comments) |
...
- [ ] All sci-comm links are in and live — add new ones to `scicomm:` as they appear
